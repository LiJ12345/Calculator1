...
public class Calculator extends JFrame implements ActionListener,KeyListener {  
    ...
    private final String[] M = { "log", "二进制" ,"x2","e"};  
    /** 计算器上键的按钮 */  
    ...
    private void init() {  
        ...
        resultText.setFont(new Font("华文新魏",Font.PLAIN,40));
        // 设置文本框背景颜色为白色  
        ...
        aa.setLayout(new GridLayout(4, 1, 3, 3));  //网格布局
    ...
    private void handleER() {  
    	int a=Integer.parseInt(resultText.getText());
        resultText.setText(Integer.toBinaryString(a));
    } 
    ...
    public static void main(String args[]) {  
        ...
        calculator1.setBounds(200,200,380,380);
